        ...
        <div className="container my-4">
            <div className="card">
                ...
                <div className="card-body d-flex justify-content-between"
                     style={{borderLeft: quiz.published ? '5px solid green' : 'none'}}>
                    <div onClick={() => {
                    ...
                    <div>
                        ...
                        {showMenu && (
                            <ul className="dropdown-menu show">
                                ...
                                <li>
                                    <button className="dropdown-item" type="button">Copy</button>
                                </li>
                                <li>
                                    <button className="dropdown-item" type="button">Sort</button>
                                </li>
                                <li>
